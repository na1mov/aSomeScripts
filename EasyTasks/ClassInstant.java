...
// варианты миллисекунд в Unix-эпохе для тестирования программы:
...
public class ClassInstant {
    ...
    public static void main(String[] args) {
        ...
        System.out.printf("На учёбу остаётся: %.0f мс.%n",
                calculateDuration(currentTime, timeToGoToSleep, TimeUnits.MILLIS));
        System.out.printf(
