...
/*
Cервис httpbin.org возвращает ответы с указанным в URL кодом состояния. Eсли отправить запрос по адресу
http://httpbin.org/status/500, сервер вернёт ответ с кодом состояния 500. Таким образом, можно эмулировать
ответы от сервера с нужным кодом состояния.
*/

class HttpClientSecond {
