...
public class HttpClientFirst {
    ...
    public static void main(String[] args) throws IOException, InterruptedException {
        ...
        // пример URL запроса, включая его параметры
        ...
        HttpRequest request = HttpRequest.newBuilder() // получаем экземпляр билдера
                ...
                //или так .header("Accept", "application/json")
        ...
        // System.out.println("Тело ответа: " + response.body()); // слишком большое тело ответа
    }
}
